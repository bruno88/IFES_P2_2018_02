...
public class Principal {
	public static void main(String[] args) {
		...
		/*
		 * contaBruno.titular = "Bruno"; contaBruno.numero = 1234; contaBruno.saldo =
		 * 100; contaBruno.limite = 300;
		 * 
		 * // Definindo os atributos do Objeto contaAna contaAna.titular = "Ana";
		 * contaAna.numero = 4321; contaAna.saldo = 800; contaAna.limite = 400;
		 */

		// Fazendo uso dos métodos da classe Conta
		/*
		 * System.out.println(contaBruno.getSaldo()); contaBruno.deposita(80);
		 * System.out.println(contaBruno.getSaldo());
		 * 
		 * contaAna.deposita(30); System.out.println(contaAna.getSaldo());
		 */
		 ...
		 * 
		 * for (int i = 0; i < contas.length; i++) { contas[i].deposita(100);
		 * System.out.println(contas[i].getTitular() + ", Saldo: R$" +
		 * contas[i].getSaldo()); }
		 */
		 ...
		 * System.out.println(contas[1].toString()); contas[0].transferePara(contas[1],
		 * 100); System.out.println(contas[0].toString());
		 * System.out.println(contas[1].toString());
		 */

		System.out.println("Digite o numero da conta de origem");
		int numero = Integer.valueOf(entrada.nextLine());
		Conta origem = Conta.pesquisaPorNumero(contas, numero);

		if (origem != null) {
			System.out.println("Digite o numero da conta de destino");
			numero = Integer.valueOf(entrada.nextLine());
			Conta destino = Conta.pesquisaPorNumero(contas, numero);
			if (destino != null) {
